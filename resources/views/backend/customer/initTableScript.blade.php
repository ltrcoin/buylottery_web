    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function (data, type, row, meta) {
          ...
          data = '<a href="javascript: void(0);" id="status' + row[0] + '" class="reverseItem" data-id="' + row[0] + '" data-href="{{route('backend.customer.reverseStatus')}}"><i class="fa fa-fw ' + icon + '"></i></a>'
          return data
        }
      },
      {
        ...
        render: function (data, type, row, meta) {
          data = '<a href="javascript:void(0)"' +
            ...
            '<input type="hidden" id="delUrl" value="/admin/customer/delete">'
          return data
        }
      }
    ],
