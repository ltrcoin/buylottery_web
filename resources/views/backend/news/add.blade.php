...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('backend.news.pAdd')}}" method="POST" enctype="multipart/form-data">
				{{csrf_field()}}
				      	...
				      	<div class="row">
					        <div class="col-md-6">
					        	<div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
					              	...
					              	<input type="text" class="form-control" name="name" id="name" placeholder="Nhập tên bài viết" maxlength="255">
					              	<span class="help-block">{{$errors->first("name")}}</span>
					            </div>
				              	<input type="hidden" class="form-control" name="alias" id="alias" placeholder="Enter alias">
					          	<!-- /.form-group -->
					          	<div class="form-group {{$errors->has('introtext') ? 'has-error' : ''}}">
					              	<label class="required" for="introtext">Mô tả ngắn</label>
					              	<textarea class="form-control" name="introtext" id="introtext" rows="4" placeholder="Nhập tên bài viết"  maxlength="350"></textarea>
				      	...
				      	<div class="row">
				      		<div class="col-md-12">
					      		<div class="form-group {{$errors->has('content') ? 'has-error' : ''}}">
				                  	...
				                  	<textarea name="content" id="content" class="form-control" rows="10" placeholder="Nhập ..."></textarea>
