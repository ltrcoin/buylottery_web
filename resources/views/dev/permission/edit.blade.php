...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('dev.permission.pEdit',['id'=>$model->permission_id])}}" method="POST">
				{{csrf_field()}}
				      	...
				      	<div class="row">
					        <div class="col-md-6">
					        	...
					        	<div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
					              	...
					              	<input type="text" class="form-control" name="name" id="name" placeholder="Enter" value="{{$model->permission_id}}">
					            ...
					            <!-- /.form-group -->
					          	...
					          	<div class="form-group">
				                  	...
				                  	<textarea name="description" id="description" class="form-control" rows="3" placeholder="Enter ...">{{$model->description}}</textarea>
				                </div>
					            <!-- /.form-group -->
					        </div>
					        <!-- /.col -->
