...
@section('title', 'Group Role')
@section('content')

<link rel="stylesheet" href="{{asset('backend/plugins/datatables/dataTables.bootstrap.css')}}">
@if (Session::has('msg_roleGroup'))
   	<script type="text/javascript">
   	$(function() {
   		jAlert('{{Session::get("msg_roleGroup")}}', 'Thông báo');
   	});
   	</script>
@endif
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">List Group Role</li>
  </ol>
</section>
					...
					<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
						<div class="row">
							<div class="col-sm-1">
								...
								<input type="hidden" id="delUrl" value="{{url('dev/role/deleteGroup')}}">
							</div>
							<div class="col-sm-11">
						...
						<div class="row">
							<div class="col-sm-12">
								<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
				        			...
				        			<tbody>
				        				@forelse ($listRoleGroup as $key => $item) 
				              			<tr class="{{$key%2 == 0 ? 'even' : 'odd'}}">
								          	...
								          	<td class="text-center">
								          		<a href="{{route('dev.role.vEditGroup',['id'=>$item->id])}}" class="editItem" id="" title="Sửa"><i class="fa fa-fw fa-edit"></i></a>
		      			...
		      			<div class="row">
	      					...
	      					<div class="col-sm-7">
	      						<div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
	      							{{ $listRoleGroup->appends($filter)->links() }}
	      						</div>
	      					</div>
	      				</div>
      				</div>    
	...
	<div class="modal-dialog" role="document">
    	<div class="modal-content">
  			...
  			<div class="form-group">
      			<form id="searchForm" action="{{route('dev.role.indexGroup')}}">
	      			<div class="modal-body">
	      				<div class="form-group">
		        			<label for="recipient-name" class="control-label">Tên group role:</label>
