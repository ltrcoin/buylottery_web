      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{Auth::guard('dev')->user()->introimage != '' ? asset(Auth::guard('dev')->user()->introimage) : asset('backend/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::guard('dev')->user()->fullname}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{Auth::guard('dev')->user()->introimage != '' ? asset(Auth::guard('dev')->user()->introimage) : asset('backend/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">

                <p>
                  {{Auth::guard('dev')->user()->fullname}}
                  <small>{{Auth::guard('dev')->user()->email}}</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{route('dev.site.logout')}}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
