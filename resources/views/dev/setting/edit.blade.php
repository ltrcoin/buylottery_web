...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Cập nhật tham số</li>
  </ol>
</section>
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('dev.setting.pEdit',['id'=>$model->id])}}" method="POST">
				{{csrf_field()}}
				      	...
				      	<div class="row">
					        <div class="col-md-6">
					        	<div class="form-group">
					              	...
					              	<input type="text" class="form-control" name="name" id="name" value="{{$model->name}}" placeholder="Nhập tên tham số">
					              	<span class="help-block">{{$errors->first("name")}}</span>
					            </div>
					            <div class="form-group {{$errors->has('content') ? 'has-error' : ''}}">
					              	<label class="required" for="content">Giá trị tham số</label>
					              	<input type="text" value="{{$model->content}}" class="form-control" name="content" id="content" placeholder="Nhập giá trị tham số">
					          	...
					          	<div class="form-group {{$errors->has('description') ? 'has-error' : ''}}">
				                  	...
				                  	<textarea name="description" id="description" class="form-control" rows="3" placeholder="Nhập ...">{{$model->description}}</textarea>
